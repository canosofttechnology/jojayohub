                  ...
                  <div class="container">
                     <div class="mobile-header__body">
                        ...
                        <a class="mobile-header__logo" href="<?php echo e(url('/')); ?>">
                           <!-- mobile-logo -->
                           <img src="<?php echo e($sensitive_data->logo); ?>" alt="">
                           <!-- mobile-logo / end -->
                        </a>
            ...
            <div class="site-header">
               ...
               <div class="site-header__middle container">
                  ...
                  <div class="site-header__phone">
                     ...
                     <div class="site-header__phone-number"><?php echo e($sensitive_data->landline); ?></div>
                  </div>
               </div>
                     ...
                     <div class="nav-panel__container container">
                        <div class="nav-panel__row">
                           <div class="nav-panel__departments">
                              ...
                              ?>
                              <div class="departments <?php echo e($class); ?>" data-departments-fixed-by=".block-slideshow">
                                                ...
                                                <div class="menu menu--layout--classic">
                                                         ...
                                                         <div class="menu__submenu" style="top:0px">
                                                            ...
                                                            <div class="menu menu--layout--classic">
                                                               ...
                                                               <ul class="menu__list">
                                                                  ...
                                                                  <li class="menu__item">
                                                                     <div class="menu__item-submenu-offset"></div>
                                                                     <a class="menu__item-link" href="<?php echo e(route('categories', $final_cat->slug)); ?>"><?php echo e($final_cat->name); ?></a>
                                                                  </li>
                                                   ...
                                                   <?php else: ?>
                                                      <li class="menu__item">
                                                         <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                                         <div class="menu__item-submenu-offset"></div>
                                                         <a class="menu__item-link" href="#"><?php echo e($secondary->name); ?></a>
                                                      </li>
                                                      <?php endif; ?>
                                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                   </ul>
                           ...
                           <div class="nav-panel__nav-links nav-links">
                              <ul class="nav-links__list">
                                 <li class="nav-links__item">
                                    <a class="nav-links__item-link" href="<?php echo e(url('/')); ?>">
                                       <div class="nav-links__item-body">Home</div>
                                    </a>
                                 </li>
                                 <li class="nav-links__item">
                                    <a class="nav-links__item-link" href="<?php echo e(url('/shop')); ?>">
                                       <div class="nav-links__item-body">Shop</div>
                                    </a>
                                 </li>
                                 <?php if(!empty($header_menu)): ?>
                                 <?php $__currentLoopData = $header_menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <li class="nav-links__item">
                                    <a class="nav-links__item-link" href="<?php echo e(route('pageDetail',$head->slug)); ?>">
                                       <div class="nav-links__item-body"><?php echo e($head->title); ?></div>
                                    </a>
                                 </li>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 <?php endif; ?>
                              ...
                              <div class="indicator indicator--trigger--click">
                                 <a href="<?php echo e(url('/cart')); ?>" class="indicator__button">
                                    <span class="indicator__area">
                                       ...
                                       <span class="indicator__value indicator__cart"><?php echo e(Cart::content()->count()); ?></span>
                                    </span>
                                 </a>
                                       ...
                                       <div class="dropcart__body">
                                          <div class="dropcart__products-list">
                                             ...
                                             <div class="dropcart__product">
                                                <div class="product-image dropcart__product-image"><a href="<?php echo e(route('single-product', $row->options->slug)); ?>" class="product-image__body"><img class="product-image__img" src="<?php echo e($row->options->image); ?>" alt="" style="width:70px"></a></div>
                                                <div class="dropcart__product-info">
                                                   <div class="dropcart__product-name"><a href="<?php echo e(route('single-product', $row->options->slug)); ?>"><?php echo e($row->name); ?></a></div>
                                          ...
                                          <div class="dropcart__buttons"> <a class="btn btn-primary" href="<?php echo e(url('/cart')); ?>">Checkout</a></div>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="indicator__dropdown">
                                    <div class="account-menu">
                                       ...
                                       <a href="account-dashboard.html" class="account-menu__user">
                                          <div class="account-menu__user-avatar"><img src="<?php echo e(Auth::user()->image); ?>" alt=""></div>
                                          <div class="account-menu__user-info">
                                             <div class="account-menu__user-name"><?php echo e(Auth::user()->name); ?></div>
                                             <div class="account-menu__user-email"><?php echo e(Auth::user()->email); ?></div>
                                          </div>
                                       </a>
                                       <div class="account-menu__divider"></div>
...
<?php /**PATH /home/jojayohub/public_html/resources/views/frontend/partials/header.blade.php ENDPATH**/ ?>