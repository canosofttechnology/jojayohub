    ...
    $(document).ready(function () {
        ...
        $("form#data").submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.ajax({
                        method: "GET",
                        url: "<?php echo e(route('brandLastData')); ?>",
                        dataType: 'json',
                        success: function(response) {
                            let lastData = response.lastData;
                            let image = lastData.logo;
                            var editUrl = '<?php echo e(route("editBrand", ":data")); ?>';
        ...
        $(document).on("click", "#check tr td .table-delete", function() {
            if(confirm("Are you sure, you want to delete this brand?"))
            {
                ...
                var url = '<?php echo e(route("brands.destroy", ":data")); ?>';
...
<?php /**PATH /home/jojayohub/public_html/resources/views/admin/scripts/brands.blade.php ENDPATH**/ ?>