            ...
            <div class="col-lg-9 offset-lg-2 col-md-9 offset-md-2 col-sm-12">
                  ...
                  <tbody class="cart-table__body">
                     ...
                     <tr class="cart-table__row">
                        <td class="cart-table__column cart-table__column--image">
                           <div class="product-image"><a href="<?php echo e(route('single-product', $row->options->slug)); ?>" class="product-image__body">
                              <img class="product-image__img" src="<?php echo e($row->options->image); ?>" alt=""></a>
                           </div>
                        </td>
                        <td class="cart-table__column cart-table__column--product">
                           <a href="<?php echo e(route('single-product', $row->options->slug)); ?>" class="cart-table__product-name"><?php echo e($row->name); ?></a>                    
                        </td>
               ...
               <div class="cart__actions">
                  <div class="cart__buttons">
                     <a href="<?php echo e(url('/shop')); ?>" class="btn btn-light">Continue Shopping</a> 
                     <a href="<?php echo e(url('/review')); ?>" class="btn btn-secondary ml-2">Proceed to Checkout</a> 
                     <a href="<?php echo e(route('destroyCart')); ?>" class="btn btn-primary cart__update-button">Destroy Cart</a>
                  </div>
               </div>
            </div>
         </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jojayohub/public_html/resources/views/frontend/pages/cart.blade.php ENDPATH**/ ?>