        ...
        },
        {
            ...
            action: function ( e, dt, node, config ) {
                ...
                if(confirm("You are about to delete "+count+" record(s). This cannot be undone. Are you sure?"))
                {
                    ...
                    url: url,
                    dataType: 'json',
                    data: { _token:"<?php echo e(csrf_token()); ?>", _method:"DELETE", ids: ids},
...
<script src="<?php echo e(asset('/vendor/fancybox/jquery.fancybox.pack.js')); ?>"></script>
...
</script><?php /**PATH /home/jojayohub/public_html/resources/views/admin/partials/footer.blade.php ENDPATH**/ ?>