      ...
      <div class="container">
         <div class="not-found">
            ...
            <div class="not-found__content">
               ...
               <a class="btn btn-secondary btn-sm" href="<?php echo e(url('/')); ?>">Go To Home Page</a>
            </div>
         </div>
      </div>
   </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jojayohub/public_html/resources/views/errors/404.blade.php ENDPATH**/ ?>