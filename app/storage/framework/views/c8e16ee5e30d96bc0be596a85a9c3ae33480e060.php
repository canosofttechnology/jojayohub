...
<aside class="aside">
    ...
    <div class="aside-inner">
        <nav data-sidebar-anyclick-close="" class="sidebar ">
                     ...
                     <div class="item user-block">
                        ...
                        <div class="user-block-picture">
                           <div class="user-block-status">
                              <img src="<?php echo e(\Auth::user()->image); ?>" alt="Avatar" width="60" height="60" class="img-thumbnail img-circle">
                              <div class="circle circle-success circle-lg"></div>
                           </div>
                        </div>
                        <!-- Name and Job-->
                        <div class="user-block-info">
                           <span class="user-block-name"><?php echo e(\Auth::user()->name); ?></span>
            ...
            <ul class='nav s-menu '>
                <li class='active' >
                  <a  title='Dashboard' href="<?php echo e(url('/auth/dashboard')); ?>">
                ...
                <li class='sub-menu '>
                  ...
                  <li class='' >
                    <a  title='Items' href="<?php echo e(route('products.index')); ?>">
                   <em class='fa fa-shopping-bag'></em><span>Products</span></a>
                  </li>
                  <?php if(Auth::user()->admin()): ?>
                  <li class='' >
                    <a  title='Supplier' href="<?php echo e(route('attributes.index')); ?>">
                   <em class='fa fa-sitemap'></em><span>Product Attribute</span></a>
                  </li>
                  <li class='' >
                    <a  title='Supplier' href="<?php echo e(route('primary_categories.index')); ?>">
                   <em class='fa fa-sitemap'></em><span>Primary Categories</span></a>
                  </li>
                  <li class='' >
                    <a  title='Supplier' href="<?php echo e(route('secondary_categories.index')); ?>">
                   <em class='fa fa-sitemap'></em><span>Secondary Categories</span></a>
                  </li>
                  <li class='' >
                    <a  title='Supplier' href="<?php echo e(route('product_categories.index')); ?>">
                   <em class='fa fa-sitemap'></em><span>Final Categories</span></a>
                  </li>
                  <li class='' >
                    <a  title='Supplier' href="<?php echo e(route('brands.index')); ?>">
                ...
                <li class='sub-menu '>
                  ...
                  <li class='' >
                    <a  title='Add News' href="<?php echo e(route('blogs.create')); ?>">
                   <em class='fa fa-plus'></em><span>Add new</span></a>
                  </li>
                  <li class='' >
                    <a  title='News List' href="<?php echo e(route('blogs.index')); ?>">
                   <em class='icon-list'></em><span>All Blog</span></a>
                  </li>
                  <li class='' >
                    <a  title='News Categories' href="<?php echo e(route('category.index')); ?>">
                ...
                <li class='sub-menu '>
                  ...
                  <li class='' >
                    <a  title='Add News' href="<?php echo e(route('page.create')); ?>">
                   <em class='fa fa-plus'></em><span>Add new</span></a>
                  </li>
                  <li class='' >
                    <a  title='News List' href="<?php echo e(route('page.index')); ?>">
                ...
                <li class='sub-menu '>
                  ...
                  <li class='' >
                    <a  title='Add User' href="<?php echo e(route('users.create')); ?>">
                   <em class='fa fa-plus'></em><span>Add new</span></a>
                  </li>
                  <li class='' >
                    <a  title='List User' href="<?php echo e(route('users.index')); ?>">
                   <em class='icon-list'></em><span>All users</span></a>
                  </li>
                  </ul>
                </li>
                <!-- <li class=''>
                  <a  title='Purchase Management' href="<?php echo e(url('/admin/expenses')); ?>">
                ...
                <li class='sub-menu '>
                  ...
                  <li class='' >
                    <a  title='Ads' href="<?php echo e(route('ads.create')); ?>">
                   <em class='fa fa-plus'></em><span>Add new</span></a>
                  </li>
                  <li class='' >
                    <a  title='Ads' href="<?php echo e(route('ads.index')); ?>">
                ...
                <li class='sub-menu '>
                  ...
                  <li class='' >
                    <a  title='Ads' href="<?php echo e(route('sliders.create')); ?>">
                   <em class='fa fa-plus'></em><span>Add new</span></a>
                  </li>
                  <li class='' >
                    <a  title='Slider' href="<?php echo e(route('sliders.index')); ?>">
                ...
                <li class='sub-menu '>
                  ...
                  <li class='' >
                    <a  title='Items' href="<?php echo e(route('sales.create')); ?>">
                   <em class='fa fa-cube'></em><span>Add new</span></a>
                  </li>
                  <li class='' >
                    <a  title='Supplier' href="<?php echo e(route('sales.index')); ?>">
                   <em class='icon-briefcase'></em><span>All Sales</span></a>
                  </li>
                  </ul>
                </li>
                <li class='' >
                  <a  title='Settings' href="<?php echo e(url('/auth/media')); ?>">
                 <em class='fa fa-upload'></em><span>File Manager</span></a>
                </li>
                <li class='' >
                  <a  title='Settings' href="<?php echo e(route('settings.index')); ?>">
...
<section>
  <div class="content-wrapper">
     <div class="content-heading">
        <a class='text-muted' href='/admin/dashboard'><?php echo e(ucfirst(Request::segment('2'))); ?></a>
        <div class="pull-right">
           <small class="text-sm">
           &nbsp; <?php echo e(date('l jS F', strtotime('Y-m-d'))); ?> - <?php echo e(date('Y')); ?>, &nbsp;Time &nbsp;<span id="txt"></span></small>
        </div>
     </div>
<?php /**PATH /home/jojayohub/public_html/resources/views/admin/partials/aside.blade.php ENDPATH**/ ?>