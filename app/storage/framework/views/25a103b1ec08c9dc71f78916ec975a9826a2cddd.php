...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/vendor/fancybox/jquery.fancybox.css')); ?>" media="screen">
    <link rel="stylesheet" href="<?php echo e(asset('/admin/css/style.css')); ?>" media="screen">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu animated zoomIn">
                        ...
                        <?php if(Auth::user()->roles == 'admin'): ?>
                            ...
                            <li>
                            <a href="<?php echo e(route('category.index')); ?>">New Category</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('blogs.create')); ?>">New Blog</a>
                            </li>

                            <li>
                                <a href="<?php echo e(route('ads.create')); ?>">New Ad</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('sales.create')); ?>">New Sale</a>
                            </li>
...
<!-- START Dropdown menu-->
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="<?php echo e(\Auth::user()->image); ?>" class="img-xs user-image"
                             alt="User Image"/>
                    ...
                    <ul class="dropdown-menu animated zoomIn">
                        ...
                        <li class="user-footer">
                            ...
                            <form method="post" action="<?php echo e(route('logout')); ?>"  class="form-horizontal">
                              <?php echo csrf_field(); ?>
...
<?php /**PATH /home/jojayohub/public_html/resources/views/admin/partials/header.blade.php ENDPATH**/ ?>