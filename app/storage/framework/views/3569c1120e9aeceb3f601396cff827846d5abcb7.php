            ...
            <div class="row">
               <div class="col-12 col-md-6 col-lg-4">
                  <div class="site-footer__widget footer-contacts">
                     ...
                     <ul class="footer-contacts__contacts">
                        <li><i class="footer-contacts__icon fas fa-globe-americas"></i> <?php echo e($sensitive_data->location); ?></li>
                        <li><i class="footer-contacts__icon far fa-envelope"></i> <?php echo e($sensitive_data->email); ?></li>
                        <li><i class="footer-contacts__icon fas fa-mobile-alt"></i> <?php echo e($sensitive_data->landline); ?>, <?php echo e($sensitive_data->landline1); ?></li>
               ...
               <div class="col-6 col-md-3 col-lg-2">
                  <div class="site-footer__widget footer-links">
                     ...
                     <ul class="footer-links__list">
                        ...
                        <?php $__currentLoopData = $footer_menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="footer-links__item"><a href="<?php echo e(route('pageDetail', $menu_list->slug)); ?>" class="footer-links__link"><?php echo e($menu_list->name); ?></a></li>
               ...
               <div class="col-6 col-md-3 col-lg-2">
                  <div class="site-footer__widget footer-links">
                     ...
                     <ul class="footer-links__list">
                        <li class="footer-links__item"><a href="<?php echo e(url('/dashboard')); ?>" class="footer-links__link">Account Dashboard</a></li>
                  ...
                  <div class="site-footer__widget footer-newsletter">
                     ...
                     <div class="social-links footer-newsletter__social-links social-links--shape--circle">
                        <ul class="social-links__list">
                           <li class="social-links__item"><a class="social-links__link social-links__link--type--youtube" href="<?php echo e($sensitive_data->youtube); ?>" target="_blank"><i class="fab fa-youtube"></i></a></li>
                           <li class="social-links__item"><a class="social-links__link social-links__link--type--facebook" href="<?php echo e($sensitive_data->facebook); ?>" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                           <li class="social-links__item"><a class="social-links__link social-links__link--type--twitter" href="<?php echo e($sensitive_data->twitter); ?>" target="_blank"><i class="fab fa-twitter"></i></a></li>
                           <li class="social-links__item"><a class="social-links__link social-links__link--type--instagram" href="<?php echo e($sensitive_data->instagram); ?>" target="_blank"><i class="fab fa-instagram"></i></a></li>
                        </ul>
                     </div>
                     <!-- social-links / end -->
                  </div>
         ...
         <ul class="mobile-links mobile-links--level--0" data-collapse data-collapse-opened-class="mobile-links__item--open">
            ...
            <li class="mobile-links__item" data-collapse-item>
               <div class="mobile-links__item-title">
                  <a href="#" class="mobile-links__item-link"><?php echo e($prime->name); ?></a> 
               ...
               <div class="mobile-links__item-sub-links" data-collapse-content>
                  <ul class="mobile-links mobile-links--level--1">
                     ...
                     <li class="mobile-links__item" data-collapse-item>
                        <div class="mobile-links__item-title">
                           <a href="#" class="mobile-links__item-link"><?php echo e($secondary->name); ?></a> 
                           <button class="mobile-links__item-toggle" type="button" data-collapse-trigger>
                              <svg class="mobile-links__item-arrow" width="12px" height="7px">
                                 <use xlink:href="/frontend/images/sprite.svg#arrow-rounded-down-12x7"></use>
                              </svg>
                        ...
                        <div class="mobile-links__item-sub-links" data-collapse-content>
                           <ul class="mobile-links mobile-links--level--2">
                              ...
                              ?>
                              <li class="mobile-links__item" data-collapse-item>
                                 <div class="mobile-links__item-title"><a href="<?php echo e(route('categories', $final_cat->slug)); ?>" class="mobile-links__item-link"><?php echo e($final_cat->name); ?></a></div>
                              </li>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           </ul>
                        </div>
...
<script type="text/javascript">
   ...
   $('.indicator__cart').html("<?php echo e(Cart::content()->count()); ?>");
   function updateCart(){
       $.ajax({
           method: "GET",
           url: "<?php echo e(route('cart.content')); ?>",
           dataType: 'json',
           success(callback_resonse){
               ...
               $.each(callback_resonse, function( key, value ){
                   ...
                   var url = "<?php echo e(route('single-product', ':data')); ?>";
               ...
               $.getScript("<?php echo e(asset('/frontend/js/jquery.min.js')); ?>")            
               cartCount();
           },
   ...
   if(confirmation){
       ...
       var url = '<?php echo e(route("cart.destroy", ":data")); ?>';
       url = url.replace(':data', data);
       $.ajax({
           method: "POST",
           url: url,
   ...
   function addcart() {
       ...
       let url = '<?php echo e(route("cart.store")); ?>';
   ...
   $(function () {
       ...
       var url = '<?php echo e(route("update.cart", ":data")); ?>';
       url = url.replace(':data', data);
           $.ajax({
               method: "POST",
               url: url,
               dataType: 'json',
               data: { _token:"<?php echo e(csrf_token()); ?>", _method:"PATCH", quantity: quantity},
               success(response){
                   toastr.success(response.data);
                   updateCart();
               },    
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5f54d0a1b938f3cb"></script>
</body>
</html><?php /**PATH /home/jojayohub/public_html/resources/views/frontend/partials/footer.blade.php ENDPATH**/ ?>