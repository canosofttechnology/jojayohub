        ...
        <div style="background: #eee;padding:10px;margin-bottom:15px">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="merchant-confirmation pull-left">
                                <span>Jojayo - Cash On Delivery</span><br>
                        ...
                        <div class="col-md-6">
                            <div class="esewa-logo pull-right">
                                <img src="/frontend/images/payment-method/cod-big.png">
                            </div>
                        </div>
                    </div><br>
                ...
                <div class="order-response">
                    ...
                    @endif
                    <p><strong>Order ID</strong> <br><span>{{ $order_id }}</span></p>                    
                    <p><strong>Total Amount</strong> <br><span>NPR {{ number_format($grand + 20) }}</span></p>
