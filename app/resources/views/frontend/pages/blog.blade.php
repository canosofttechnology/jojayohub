         ...
         <div class="page-header__breadcrumb">
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">
                     <a href="">{{ $blog_detail->category->name }}</a> 
                     <svg class="breadcrumb-arrow" width="6px" height="9px">
                        <use xlink:href="images/sprite.svg#arrow-rounded-right-6x9"></use>
                     </svg>
                  </li>
         ...
         <div class="col-12 col-lg-8">
            <div class="block post post--layout--classic">
               <div class="post__header post-header post-header--layout--classic">
                  <div class="post-header__categories"><a href="">{{ $blog_detail->category->name }}</a></div>
                  <h1 class="post-header__title">{{ $blog_detail->title }}</h1>
               ...
               <div class="post__featured"><a href=""><img src="{{ asset('/uploads/blog/Thumb-'.$blog_detail->image) }}" alt=""></a></div>
               ...
               <div class="block-sidebar__item">
                  <div class="widget-posts widget">
                     ...
                     <div class="widget-posts__list">
                         @if(!empty($all_blogs))
                         @foreach($all_blogs as $post_detail)
                        <div class="widget-posts__item">
                           <div class="widget-posts__image"><a href=""><img src="{{ asset('/uploads/blog/Thumb-'.$post_detail->image) }}" alt=""></a></div>
                           <div class="widget-posts__info">
                              <div class="widget-posts__name"><a href="{{ route('blog-detail',$post_detail->slug) }}">{{ $post_detail->title }}</a></div>
                              <div class="widget-posts__date">{{ date('F d, Y', strtotime($post_detail->created_at)) }}</div>
                           </div>
                        </div>
                        @endforeach
                        @endif
