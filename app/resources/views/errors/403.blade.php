...
<p>> <span>SOME PAGES ON THIS SERVER THAT YOU DO HAVE PERMISSION TO ACCESS</span>: [<a href="/auth/dashboard">Dashboard</a>...]</p><p>> <span>HAVE A NICE DAY {{ ucwords(Auth::user()->name) }} :-)</span></p>
</div>
<script>
