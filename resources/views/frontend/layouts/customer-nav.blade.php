...
<aside class="sidebar col-lg-3">
    <div class="widget widget-dashboard">
        ...
        <ul class="list">
            ...
            <li @if(@$title == 'account-information') class="active" @endif><a href="{{ route('customer.changepassword.form') }}">Change Password</a></li>
            {{-- <li @if(@$title == 'address-book' || @$title == 'add-address') class="active" @endif><a href="{{ url('/address-book') }}">Address Book</a></li>
            <li @if(@$title == 'my-oders') class="active" @endif><a href="#">My Orders</a></li>
