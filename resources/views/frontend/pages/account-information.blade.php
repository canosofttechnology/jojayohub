...
@include('frontend.layouts.front-nav')
            <form method="POST" action="{{ route('customer.account.update') }}" accept-charset="UTF-8" class="form" id="address_update" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group required-field">
                                    <label for="acc-name">Full Name <span class="text-danger">*</span></label>
                                    <input type="text" value="{{ $user->name }}" class="form-control"  name="name" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group required-field">
                                  <label for="acc-email">Email <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group required-field">
                                    <label for="acc-name">Phone <span class="text-danger">*</span></label>
                                    <input type="text" value="{{ $user->contact }}" class="form-control" name="contact" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group required-field">
                                ...
                                <input type="password" class="form-control" id="acc-pass2" name="current_password">
                            </div>
                        </div>
