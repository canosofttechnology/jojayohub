                  ...
                  <div class="input-radio-color">
                    <div class="input-radio-color__list">
                        ...
                        @if(!empty($unique_product_colors))
                            ...
                            <label class="input-radio-color__item input-radio-color__item--white" style="color: {{ $color_data->colorInfo->name }};" data-toggle="tooltip" title="White"><input type="radio" name="color"> <span></span></label> 
                            @endforeach
                        @endif                                              
                    </div>
                  </div>
