<div id="vendor">
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" value="{{ @$vendor_data->company }}" readonly id="company" >
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" value="{{ @$vendor_data->vendor_address }}" readonly id="address">
            <span class="messages"></span>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" value="{{ @$vendor_data->company_address }}" readonly id="address">
            <span class="messages"></span>
        </div>
    </div>
